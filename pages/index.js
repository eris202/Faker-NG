  ...
  return (
    <>
          ...
          <div className="col-md-7">
            <div className="text-bg">
              ...
              <div className="summary">
                With thise tool, you can generate thousands on nigerian data in
                a JSON or list format.
              </div>
              <div className="clearfix"></div>

              <a
                className="btn btn-lg mt-4 text-white btn-success"
                href="#"
      ...
      <div className="container text-bg">
        ...
        <div>
        Contact: <a className="text-bg"  href="mailto:erisanakorede@gmail.com">erisanakorede@gmail.com</a>
        </div>
      </div>
    </>
  );
